...
<section {{ $attributes->merge([
    ...
    <div class="flex flex-wrap items-center gap-3 border-b border-gray-200 px-4 py-3">
        <button type="button"
                ...
                class="min-w-0 flex-1 rounded text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500">
        ...
        <div class="flex items-center gap-2">
            <button type="button"
                    ...
                    wire:target="addField('text', '{{ $section['id'] }}')"
                    wire:loading.attr="disabled"
                    wire:loading.class="opacity-60"
                    class="inline-flex items-center gap-1.5 rounded-md border border-gray-200 px-2.5 py-1.5 text-xs font-medium text-gray-700 transition hover:border-indigo-300 hover:text-indigo-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 disabled:cursor-wait">
            ...
            <x-builder::icon-button
                ...
                wire:target="removeSection('{{ $section['id'] }}')"
                wire:loading.attr="disabled"
        ...
        @empty
            <p class="rounded-lg border border-dashed px-4 py-6 text-center text-sm transition"
               ...
               x-on:drop.prevent="
                   ...
                   reset();
               ">
                <span x-show="draggingId === null">This section is empty. Add a field from the palette, or drag one here.</span>
